            ...
            <div class="col-sm-4 col-sm-offset-4 col-md-4 col-md-offset-4 main">
                ...
                <div id="sCenter">
                    <p>
                        ...
                        |   
                    <asp:Button class="HyperButton" runat="server" ID="CompleteB" Text="Complete List" OnClick="CompleteB_Click" />
                    </p>
                </div>
            </div>
        </div>
    ...
    <div>
        <div class="well">
            <asp:ListView ID="ListView1" runat="server"
                ...
                <EmptyDataTemplate>
                    You have yet to add any homework
                </EmptyDataTemplate>
                <LayoutTemplate>
                            ...
                            <tr class="sections">
                                <td class="sections">
                                    <div class="container-fluid">
                                        ...
                                        <a class="GlyphButton" href="<%# FriendlyUrl.Href("~/HomeWork/Edit", Item.HomeWorkID) %>"> <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                                        |  
                                        ...
                                        <p>&nbsp;</p>
                                        <asp:HyperLink class="HyperButton" runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/HomeWork/Finish", Item.HomeWorkID) %>' Text="Complete" />
